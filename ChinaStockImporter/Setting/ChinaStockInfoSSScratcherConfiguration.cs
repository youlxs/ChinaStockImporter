...
{
    public class ChinaStockInfoSSScratcherConfiguration : IScratcherConfig
    {
        private const string StoreFolder = "ChinaStockInfoSS";
        private ILogger logger;

        public ChinaStockInfoSSScratcherConfiguration()
        {
        ...
        public string GetScratchPage()
        {
            try
            {
                var configValue = System.Configuration.ConfigurationManager.AppSettings["ChinaStockInfoSSScratchPage"];
                return configValue;
            }
            catch (Exception e)
            {
        ...
        public string GetScratchDataPage()
        {
            try
            {
                var configValue = System.Configuration.ConfigurationManager.AppSettings["ChinaStockInfoSSScratchDataPage"];
                return configValue;
            }
            catch (Exception e)
            {
